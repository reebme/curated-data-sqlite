-- fin11a thtrough fin11f
-- base data and conditional data together with derived values
-- only countries/economies included,
-- aggregates excluded
select
...
where
	...
	and wf_base."INDICATOR" GLOB '*FIN11[ABCDEF]'
